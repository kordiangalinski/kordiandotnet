...
const Projects = (): JSX.Element => {
    const Title = Title_Path + "Projects";
    ...
    return (
        <>
            ...
            <Layout>
                <h1 className="text-3xl text-slate-300 border-b border-slate-400 mb-2">Recent Projects</h1>
    ...
    return(
        <div className="p-2 shadow-xl text-slate-400">
            ...
            <div className="flex justify-between p-1">
                <Link href={`/projects/${props.id}`} className="font-bold">Read More</Link>
