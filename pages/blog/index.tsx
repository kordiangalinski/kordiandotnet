...
const Blog = (): JSX.Element => {
    ...
    return (
        <>
            ...
            <Layout>
                <h1 className="text-3xl text-slate-300 border-b border-slate-400 mb-2">Recent Blog Posts</h1>
    ...
    return(
        <div className="p-2 shadow-xl text-slate-400">
            ...
            <div className="flex justify-between p-1">
                <Link href={`/blog/${props.id}`} className="font-bold">Read More</Link>
